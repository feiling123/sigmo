const en = {
  ...
  modemDetail: {
    ...
    esim: {
      ...
      transferConfirmDescription: 'After transfer, the original SIM or eSIM may become invalid. If transfer fails, contact your carrier to replace or restore the line.',
      ...
      transferDeleteSourceHint: 'The carrier requires deleting the source profile ({iccid}) before continuing.',
    ...
    settings: {
      ...
      internetAdvancedDescription: 'Only change these when your carrier requires a specific IP family or APN credentials.',
